    ...
    <div className="min-h-screen">
      ...
      <article className="pt-32 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Content */}
          <div className="prose prose-slate dark:prose-invert prose-lg max-w-none prose-headings:font-semibold prose-a:text-indigo-600 dark:prose-a:text-indigo-400 prose-code:text-indigo-600 dark:prose-code:text-indigo-400">
            {post.content.split("\n").map((paragraph, index) => {
          ...
          {/* CTA */}
          <div className="mt-12 p-8 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white text-center">
            <h3 className="text-2xl font-bold mb-2">Ready to Try DropVox?</h3>
            <p className="text-indigo-100 mb-6">
              Free, private, and offline audio transcription for Mac.
            </p>
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-indigo-600 font-semibold transition-all hover:scale-105 shadow-lg"
            >
              <svg
                className="w-5 h-5"
                fill="none"
          ...
          <div className="mt-12 grid sm:grid-cols-2 gap-4">
            {prevPost && (
              <Link
                ...
                className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-indigo-200 dark:hover:border-indigo-800 transition-colors"
              >
            ...
            {nextPost && (
              <Link
                ...
                className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-indigo-200 dark:hover:border-indigo-800 transition-colors sm:text-right"
              >
